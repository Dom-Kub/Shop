...
public class UpdateProductReguest {
    ...
    public UpdateProductReguest(@NonNull String name, @NonNull String description, double price, int available) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        UpdateProductReguest that = (UpdateProductReguest) o;
